...
# %%
frame_a  = tools.imread( '/home/user/Software/openpiv-python/openpiv/examples/test1/exp1_001_a.bmp' )
frame_b  = tools.imread( '/home/user/Software/openpiv-python/openpiv/examples/test1/exp1_001_b.bmp' )
